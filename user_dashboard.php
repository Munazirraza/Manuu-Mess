    ...
    <div class="row">
      <div class="col-md-3">
        <div class="card">
          ...
          <div class="card-body">
            <b>Breakfast:</b> 07:30 AM to 09:30 AM <br>
            <b>Lunch:</b> 12:00 PM to 2:00 PM <br>
            <b>Snaks:</b> 5:00 PM to 6:00 PM <br>
      ...
      <div class="col-md-3">
        <div class="card">
          ...
          <div class="card-body">
            <ul>
              <marquee direction="up" scrollamount="2"><li><a>1. Mess facality will be  provided till 4th August 2022.</a></li>
              <li><a>2. Please pay the all dues bill before leaving hostel other wise your Result will be Hold.</a></li>
